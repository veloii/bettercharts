          ...
          <div className="relative">
            <div className="sm:text-center">
              ...
              <p className="mt-6 mx-auto max-w-2xl text-lg text-emerald-100">
                All you need is your access code and your date of birth. No new
                account. No password. No tracking or linking to anything.
              </p>
            </div>
            <div className="mt-12 sm:mx-auto sm:max-w-lg sm:flex justify-center items-center">
              <a href="https://app.bettercharts.zelr.me">
                <button
                  type="submit"
